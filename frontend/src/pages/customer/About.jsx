      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl font-black text-slate-900 mt-1 tracking-tight">
            Redefining Self-Drive Mobility in South India
          </h1>
          <p className="text-sm text-slate-500 mt-3 leading-relaxed">
            Founded with a vision to eliminate the friction, hidden fees, and uncertainty of car rentals, Akash Car Rental operates a modern, meticulously maintained fleet across Bengaluru and Mysuru.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-6 rounded-3xl bg-white border border-slate-200 text-center shadow-sm">
            <span className="text-3xl font-black text-brand-600 block">50+</span>
            <span className="text-xs font-bold text-slate-500 mt-1 block">Vehicles in Fleet</span>
          </div>
          <div className="p-6 rounded-3xl bg-white border border-slate-200 text-center shadow-sm">
            <span className="text-3xl font-black text-emerald-600 block">12k+</span>
            <span className="text-xs font-bold text-slate-500 mt-1 block">Successful Trips</span>
          </div>
          <div className="p-6 rounded-3xl bg-white border border-slate-200 text-center shadow-sm">
